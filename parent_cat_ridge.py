...
def run_ridge_on_cat(cat):
    if not is_in_cache('cat_ridges_' + cat):
        ...
        results = run_cv_model(tfidf_train, tfidf_test, target, runRidge5, rmse, cat + '-titlecat-ridge')
        ...
        results = run_cv_model(tfidf_train2, tfidf_test2, target, runRidge5, rmse, cat + '-desc-ridge')
        ...
        results = run_cv_model(tfidf_train3, tfidf_test3, target, runRidge5, rmse, cat + '-desc-char-ridge')
        ...
        results = run_cv_model(train_c2, test_c2, target, runRidge8, rmse, cat + '-text-ridge')
